<section id="speakers"   class="section-with-bg">
    <div class="container wow fadeInUp" style="height:1000px;">
    ...
    <div class="row">
          ...
          {{--<div class="col-lg-4 col-md-6">--}}
              {{--<div class="speaker">--}}
                  {{--<img src="/img/speakers/1.jpg"  class="img-fluid">--}}
                  {{--<div class="details">--}}
        ...
        <div class="col-lg-4 col-md-6">
            <div class="speaker">
                <img src="/img/speakers/1.jpg"  class="img-fluid" height="500px;">
                {{--<div class="details">--}}
                {{--<h3><a href="{{ route('speaker', $speaker->id) }}">{{ $speaker->name }}</a></h3>--}}
                {{--<p>{{ $speaker->description }}</p>--}}
                {{--<div class="social">--}}
        ...
        <div class="col-lg-4 col-md-6">
            <div class="speaker">
                <img src="/img/speakers/2.jpg"  class="img-fluid">
                {{--<div class="details">--}}
                {{--<h3><a href="{{ route('speaker', $speaker->id) }}">{{ $speaker->name }}</a></h3>--}}
                {{--<p>{{ $speaker->description }}</p>--}}
                {{--<div class="social">--}}
        ...
        <div class="col-lg-4 col-md-6">
            <div class="speaker">
                <img src="/img/speakers/3.jpg"  class="img-fluid">
                {{--<div class="details">--}}
                {{--<h3><a href="{{ route('speaker', $speaker->id) }}">{{ $speaker->name }}</a></h3>--}}
                {{--<p>{{ $speaker->description }}</p>--}}
                {{--<div class="social">--}}
