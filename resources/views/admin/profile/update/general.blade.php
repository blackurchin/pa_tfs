...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <input type="text" id="firstName" name="middlename" placeholder="Middle Name" class="form-control">
    </div>
    <div class="col-sm-4">
        <input type="text" id="firstName" name="lastname" placeholder="Last Name" class="form-control" required>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-xs-12 col-sm-10">
        ...
        <div class="form-group row">
            ...
            <div class="form-group row col-sm-3 ml-1">
                ...
                <input type="text" name="dietary_restriction" class="form-control" id="dietaryRestriction" placeholder="(if any)">
            </div>
        </div>
    </div>
</div>
