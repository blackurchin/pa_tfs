...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} New
        {{--{{ trans('cruds.sponsor.title_singular') }}--}}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.host_country.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.host_country.fields.name') }}*</label>
            ...
            <div class="form-group {{ $errors->has('cat') ? 'has-error' : '' }}">
                <label for="name">{{ trans('cruds.host_country.fields.cat') }}*</label>
