...
<div class="form-group row">
    ...
    <div class="form-group col-md-2">
        <input type="text" name="flight_number" class="form-control" id="flightNumber" placeholder="Flight Number">
    </div>
    <div class="form-group col-md-2">
...
<div class="form-group row">
    ...
    <div class="form-group col-md-2">
        <input type="text" name="departure" class="form-control" id="departure" placeholder="Flight Number">
    </div>
    <div class="form-group col-md-2">
    ...
    <div class="form-group col-md-3">
        {{--<label for="inputState">Arrival</label>--}}
        <input type="text" name="departure_time datetime" class="form-control timepicker" id="departureTime" placeholder="Time of Departure (24HR format)">
    </div>
    <div class="form-group col-md-3">
        {{--<label for="inputState">Arrival</label>--}}
