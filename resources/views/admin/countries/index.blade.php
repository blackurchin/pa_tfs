            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Setting">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.country.fields.phone') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.country.fields.languages') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($countries as $key => $country)
                        <tr data-entry-id="{{ $country->code }}">
                            ...
                            <td>
                                @can('country_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.countries.show', $country->code) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('country_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.countries.edit', $country->code) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('country_delete')
                                    <form action="{{ route('admin.countries.destroy', $country->code) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
