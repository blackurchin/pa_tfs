        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is('admin/permissions*') ? 'menu-open' : '' }}{{ request()->is('admin/roles*') ? 'menu-open' : '' }} {{ request()->is('admin/participants*') ? 'menu-open' : '' }} {{ request()->is('admin/attendees*') ? 'menu-open' : '' }} {{ request()->is('admin/users*') ? 'menu-open' : '' }}">
                        <a class="nav-link nav-dropdown-toggle" href="#">
                            ...
                            <p>
                                ...
                                @else
                                    <span>{{ trans('cruds.Participant.title') }}</span>
                                    <i class="right fa fa-fw fa-angle-left"></i>
                                @endif
                            </p>
                        </a>
                            ...
                            @can('user_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.participants.index") }}" class="nav-link {{ request()->is('admin/participants') || request()->is('admin/participants/*') ? 'active' : '' }}">
                                        ...
                                        <p>
                                            <span>{{ trans('cruds.Participant.invited_singular') }}</span>
                                        </p>
                                    </a>
                                </li>
                                    <li class="nav-item">
                                        <a href="{{ route('admin.attendees.index') }}" class="nav-link {{ request()->is('admin/attendees') || request()->is('admin/attendees/*') ? 'active' : '' }}">
                                            ...
                                            <p>
                                                <span>{{ trans('cruds.attendee.title') }}</span>
                                            </p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route("admin.users.index") }}" class="nav-link {{ request()->is('admin/users') || request()->is('admin/users/*') ? 'active' : '' }}">
                                            ...
                                            <p>
                                                ...
                                                <span>{{ trans('cruds.user.title') }}</span>
                                                 @else
                                                    <span>{{ trans('cruds.user.register') }}</span>
                                                @endif
                                            </p>
                                        </a>
                                    </li>
                ...
                @can('profile_access')
                    <li class="nav-item">
                        <a href="{{ route('admin.profiles.index') }}" class="nav-link {{ request()->is('admin/profiles') || request()->is('admin/profiles/*') ? 'active' : '' }}">
                            ...
                            <p>
                                <span>{{ trans('cruds.profile.title_singular') }}</span>
                            </p>
                        </a>
                    </li>
                    @endcan
                    ...
                    <li class="nav-item">
                        <a href="{{ route("users.password.change_password") }}" class="nav-link {{ request()->is('users/change-password') || request()->is('users/change-password/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-key">

                            </i>
                            <p>
                                <span>{{ trans('cruds.change_password.title') }}</span>
                            </p>
                        </a>
                    </li>
                  @endif
                @can('bilateral_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.bilaterals.index") }}" class="nav-link {{ request()->is('admin/bilaterals') || request()->is('admin/bilaterals/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-calendar">

                            </i>
                            <p>
                                <span>{{ trans('cruds.bilateral.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
                ...
                {{--@can('sponsor_access')--}}
                    {{--<li class="nav-item">--}}
                        {{--<a href="{{ route("admin.sponsors.index") }}" class="nav-link {{ request()->is('admin/sponsors') || request()->is('admin/sponsors/*') ? 'active' : '' }}">--}}
                            ...
                            {{--</i>--}}
                            {{--<p>--}}
                                {{--<span>{{ trans('cruds.sponsor.host') }}</span>--}}
{{--                                <span>{{ trans('cruds.sponsor.title') }}</span>--}}
                            {{--</p>--}}
                        {{--</a>--}}
                    {{--</li>--}}
                {{--@endcan--}}
                    @can('host_country_access')
                        <li class="nav-item">
                            <a href="{{ route("admin.host_country.index") }}" class="nav-link {{ request()->is('admin/host_country') || request()->is('admin/host_country/*') ? 'active' : '' }}">
                                <i class="fa-fw fas fa-hand-holding-usd">
